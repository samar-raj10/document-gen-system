        ...
        <section className="px-6 py-8 md:px-12 md:py-10 bg-linear-to-r from-white to-amber-50 border-b border-amber-100">
          <div className="max-w-4xl mx-auto">
            ...
            <p className="text-neutral-600 text-lg">
              Submit your request for a Character Certificate below.
            </p>
          </div>
        </section>
          ...
          <div className="max-w-4xl mx-auto">
              ...
              {submitted ? (
                <div className="text-center py-8">
                  ...
                  <p className="text-neutral-600">
                    Your Character Certificate request has been submitted. You will be notified once it is processed.
                  </p>
                </div>
              ) : (
                <form onSubmit={handleSubmit} className="space-y-6">
                  ...
                  <div>
                    ...
                    <textarea
                      ...
                      placeholder="Please provide the reason for requesting a Character Certificate (e.g., job application, higher education, government job)..."
                    />
                  </div>
            ...
            <div className="mt-8 p-6 bg-amber-50 border border-amber-200 rounded-lg">
              ...
              <p className="text-sm text-neutral-700">
                A Character Certificate is an official document that vouches for your good conduct and character. It is commonly required for job applications, higher education admissions, and government positions.
              </p>
            </div>
          </div>
        </section>
