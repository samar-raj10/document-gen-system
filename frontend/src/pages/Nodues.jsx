        ...
        <section className="px-6 py-8 md:px-12 md:py-10 bg-linear-to-r from-white to-amber-50 border-b border-amber-100">
          <div className="max-w-4xl mx-auto">
            ...
            <p className="text-neutral-600 text-lg">
              Submit your request for a No-Dues Certificate below.
            </p>
          </div>
        </section>
          ...
          <div className="max-w-4xl mx-auto">
              ...
              {submitted ? (
                <div className="text-center py-8">
                  ...
                  <p className="text-neutral-600">
                    Your No-Dues Certificate request has been submitted. You will be notified once it is processed.
                  </p>
                </div>
              ) : (
                <form onSubmit={handleSubmit} className="space-y-6">
                  ...
                  <div>
                    ...
                    <textarea
                      ...
                      placeholder="Please provide the reason for requesting a No-Dues Certificate (e.g., graduation clearance, job requirement, transfer)..."
                    />
                  </div>
            ...
            <div className="mt-8 p-6 bg-amber-50 border border-amber-200 rounded-lg">
              ...
              <p className="text-sm text-neutral-700">
                A No-Dues Certificate certifies that you have cleared all financial and non-financial dues from the institution. It is typically required at the time of graduation or transfer.
              </p>
            </div>
          </div>
        </section>
